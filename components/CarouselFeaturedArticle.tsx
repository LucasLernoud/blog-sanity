...
function CarouselFeaturedArticle({ post }: Props) {
  return (
    <div className="pb-4">
      <div
        key={post._id}
        className={`flex rounded-lg border border-gray-200 bg-black/10 shadow-lg transition duration-300 ease-in hover:bg-black/40 dark:border-gray-700`}
      >
        {/* Bloc entier image */}
        <div className="relative h-60 w-full ">
          <div
            className="h-60 w-full bg-cover bg-center gradient-mask-r-0 "
            style={{
...
export default CarouselFeaturedArticle;
