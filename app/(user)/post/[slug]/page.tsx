...
async function Post({ params: { slug } }: Props) {
  ...
  return (
    <article className="px-10 pb-28">
      <section className="space-y-2 border border-[#351581] text-white">
        <div className="min-h-56 flexx flec-col relative justify-between md:flex-row">
          ...
          <section className="w-full bg-[#4e7c30] p-5">
